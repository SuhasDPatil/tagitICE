...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        [closeButton setTitleColor:[UIColor colorWithRed:0.1f green:0.1f blue:0.1f alpha:1.0f] forState:UIControlStateNormal];
        [closeButton setTitleColor:[UIColor colorWithRed:0.4f green:0.4f blue:0.4f alpha:0.5f] forState:UIControlStateHighlighted];
